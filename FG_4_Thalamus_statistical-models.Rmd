...
#ggsave(barplotarrange.etiv, filename="figures/barplots_glm_etiv_B.png", width=30, height=25, dpi=300)
```
...
ggsave(barplotarrange.etiv_fdr, filename="figures/barplots_glm_etiv_fdr_C.png", width=30, height=25, dpi=300)
```
...
ggsave(barplotarrange.whole_fdr, filename="figures/barplots_glm_whole_fdr_C.png", width=25, height=25, dpi=300)
```
